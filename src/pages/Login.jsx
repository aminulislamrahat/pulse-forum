                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between mb-2">
                            ...
                            <a onClick={() => navigate('/forgot-password')} className="text-xs hover:underline  cursor-pointer">Forgot password?</a>
                        </div>
                        <div className="relative">
                            ...
                            {errors.password && <span className="text-red-500 text-xs">Password required (min 6 chars)</span>}
                        </div>
                    </div>
                </div>
