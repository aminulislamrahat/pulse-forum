...
const MembershipPage = () => {
  ...
  return (
    <div className="w-full mx-auto p-6 md:p-12  bg-base-100">
      ...
      <div className="w-full mx-auto max-w-4xl grid gap-6 md:grid-cols-2">
        {/* Free/Bronze Card */}
        <div className="rounded-2xl border-2 border-gray-200 bg-base-100 p-8 shadow-md flex flex-col">
          ...
          <button className="btn btn-outline btn-disabled mt-auto">
            Current Plan
          </button>
        </div>
      ...
      {showStripe && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="relative bg-base-100 rounded-xl shadow-xl w-full max-w-md mx-auto px-8 py-8 border border-gray-100">
            <button
