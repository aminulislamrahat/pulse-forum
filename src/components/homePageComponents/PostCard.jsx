...
export default function PostCard({ post }) {
  ...
  return (
    <div
      className="rounded-xl bg-base-100 shadow hover:shadow-lg cursor-pointer transition p-5 flex flex-col gap-2 border border-base-100"
      onClick={handleClick}
      tabIndex={0}
    ...
    >
      ...
      <div className="flex items-center gap-4 text-xs text-gray-500 mt-2">
        ...
        <span>Votes: {(post.upvotes || 0) - (post.downvotes || 0)}</span>
      </div>
    </div>
  );
}
