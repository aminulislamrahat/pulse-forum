        ...
        >
          {announcements.map((ann) => (
            <SwiperSlide key={ann._id}>
              <div className="flex flex-col rounded-xl md:flex-row items-center justify-between gap-6 md:gap-10 bg-base-100  p-6 md:p-10 min-h-[320px] shadow-xl relative">
                {/* Left Side (Text) */}
                <div className="flex-1 text-center md:text-left md:pl-4 flex flex-col justify-center">
