        ...
        <section className="w-full mx-auto py-10 px-4 md:px-10 lg:px-36">
            <div className="w-full mx-auto bg-base-200 rounded-2xl p-2 lg:p-12">
                <Fade direction="down" triggerOnce>
                    <div className="text-center mb-14">
                        ...
                        <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600">
                            Dive into the latest public posts from our Pulse Forum community. <br />
                            Share your insights, connect through conversation, and discover trending topics!
                        </p>
                    </div>
                </Fade>
                ...
                <div className="flex w-10/12 mx-auto items-center justify-between mb-4">
                    <div>
                        <button
                            className={`btn btn-sm mr-2 ${sort === "recent" ? "btn-primary" : "btn-outline"}`}
                ...
                {/* Posts */}
                {isLoading ? (
                    <div className="flex w-10/12 mx-auto justify-center py-10">
                        <span className="loading loading-spinner loading-lg text-primary"></span>
                    </div>
                ) : data?.posts?.length === 0 ? (
                    <div className="text-center text-gray-400 py-10">No posts found with this tag.</div>
                ) : (
                ...
                {/* Pagination */}
                {data?.total > limit && (
                    <div className="flex w-10/12 mx-auto justify-center mt-8">
                        <Pagination
                            page={page}
                            setPage={setPage}
                            total={data.total}
