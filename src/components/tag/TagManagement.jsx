    ...
    <div className="w-full bg-base-100 mx-auto p-6 md:p-12">
      <div className="mb-8">
        ...
        <p className="text-center text-gray-500 mb-4">
          Add, edit, and delete post categories. These tags help users find and
          filter posts.
        </p>
      </div>
      {/* Add Tag Form */}
      <div className="card shadow-lg bg-base-300 rounded-xl max-w-md mx-auto mb-8 px-6 py-6">
        <form
        ...
        >
          ...
          <button
            type="submit"
            className="btn btn-primary px-6 font-semibold text-base"
          >
            Add Tag
          </button>
        </form>
      ...
      <div className="overflow-x-auto">
        <table className="table table-zebra w-full rounded-xl shadow bg-base-300">
          <thead>
